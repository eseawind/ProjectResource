...
-- ----------------------------
DROP TABLE REPORT_LOGGERINFO;
CREATE TABLE REPORT_LOGGERINFO(
...
-- ----------------------------
ALTER TABLE REPORT_LOGGERINFO ADD CHECK ("ID" IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table GW_REPORT_LOGGERINFO
-- ----------------------------
ALTER TABLE REPORT_LOGGERINFO ADD PRIMARY KEY ("ID");

select * from REPORT_LOGGERINFO;
