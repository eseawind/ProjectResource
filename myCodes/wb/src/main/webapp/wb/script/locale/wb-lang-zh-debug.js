var Str = {
  ...
  expExcel: '当前页至Excel',
  expExcelAll: '全部页至Excel',
  expPreview: '当前页至预览',
  expPreviewAll: '全部页至预览',
  expText: '当前页至文本',
  expTextAll: '全部页至文本',
  falseStr: '否',
  file: '文件',
  ...
  requiredField: '{0}为必输项。',
  reset: '重置',
  save: '保存',
  saveAsAllDesktop: '保存为所有桌面',
