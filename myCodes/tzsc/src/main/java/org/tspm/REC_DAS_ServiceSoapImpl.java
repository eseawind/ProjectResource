...
@javax.jws.WebService(
                      ...
                      portName = "REC_DAS_ServiceSoap",
                      targetNamespace = "http://tempuri.org/",
                      wsdlLocation = "file:/F:/REC_DAS-Service.wsdl",
                      endpointInterface = "org.tspm.RECDASServiceSoap")
                      
public class REC_DAS_ServiceSoapImpl implements RECDASServiceSoap {

    private static final Logger LOG = Logger.getLogger(REC_DAS_ServiceSoapImpl.class.getName());
