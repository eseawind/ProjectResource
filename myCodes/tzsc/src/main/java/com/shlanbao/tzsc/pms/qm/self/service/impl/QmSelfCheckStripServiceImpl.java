package com.shlanbao.tzsc.pms.qm.self.service.impl;
 ...
 */
@Service
public class QmSelfCheckStripServiceImpl extends BaseService implements QmSelfCheckStripService{
	@Autowired
	private QmSelfCheckStripDaoI qmSelfCheckStripDao;
	@Override
	public DataGrid queryList(QmSelfCheckStripBean bean, PageParams pageParams) throws Exception{
