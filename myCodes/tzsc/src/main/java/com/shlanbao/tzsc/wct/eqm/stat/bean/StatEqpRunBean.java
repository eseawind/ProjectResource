package com.shlanbao.tzsc.wct.eqm.stat.bean;

public class StatEqpRunBean {
	...
	public StatEqpRunBean() {
		// TODO Auto-generated constructor stub
	}
	public StatEqpRunBean(Double[] values, Double[] values2,
	...
	public StatEqpRunBean(Double[] values, Double[] values2, Double[] values3,
			String[] lables, int pageIndex, int pageSize, int count) {
		super();
		this.values = values;
		this.values2 = values2;
	...
	public StatEqpRunBean(Double[] values,String[] lables, int pageIndex, int pageSize, int count) {
		super();
		this.values = values;
		this.lables = lables;
		this.pageIndex = pageIndex;
