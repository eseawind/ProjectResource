...
*
 */
public class EqmCheckParamBean{
	...
	private String querySysCId;//数据字典大类ID
	...
	private String djType;//点检类型
	private String djMethodId;//点检方式  
	private String djMethodName;//点检方式  
	...
	private String number;//维修主管检查次数
	...
	public String getDjMethodName() {
		return djMethodName;
	}
	public void setDjMethodName(String djMethodName) {
		this.djMethodName = djMethodName;
	}
	...
	public String getQuerySysCId() {
		return querySysCId;
	}
	public void setQuerySysCId(String querySysCId) {
		this.querySysCId = querySysCId;
	}
