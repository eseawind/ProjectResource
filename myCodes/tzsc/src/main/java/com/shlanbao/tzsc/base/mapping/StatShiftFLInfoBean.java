 ...
 */
@Entity
public class StatShiftFLInfoBean implements Serializable{
	...
	private Double zj_pz;  //卷烟机-盘纸
	private Double zj_ssz; //卷烟机-水松纸
	private Double zj_lb;  //卷烟机-滤棒
	private Double zj_szy; //卷烟机-散支烟
	private Double zb_lbz; //包装机-铝箔纸	
	private Double zb_xhz; //包装机-小盒纸	
	private Double zb_xhm; //包装机-小盒膜	
	private Double zb_thz; //包装机-条盒纸	
	private Double zb_thm; //包装机-条盒膜	卡纸（硬盒）/封签（软盒）	
	private Double zb_kz;  //包装机-卡纸
	private Double zb_fq;  //包装机-封签
	private Double zb_lx1;  //包装机-拉线1
	private Double zb_lx2;  //包装机-拉线2
	private Double zl_pz;  //成型机-盘纸
	private Double zl_ss;  //成型机-丝束
	private Double zl_gy;  //成型机-甘油
	private Double yf_xp;  //封箱机-箱皮
	private Double yf_jd;  //封箱机-胶带
	private Double qt_bfy; //残烟-报废烟
	private Double qt_cc;  //残烟-吹车
	private Double qt_jy;  //残烟 - 卷烟
	private Double qt_bz;  //残烟 - 包装
	
	private Double zl_dkj; //成型机——搭口胶
	private Double zl_rrj; //成型机- 热熔胶
