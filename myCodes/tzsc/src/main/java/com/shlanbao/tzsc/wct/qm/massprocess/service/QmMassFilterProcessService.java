 ...
 */
public interface QmMassFilterProcessService {
	/**
	 * 查询
	 */
	DataGrid queryList(QmMassFilterProcessBean bean,PageParams pageParams) throws Exception;
	 ...
	 * @throws Exception
	 */
	void editBean(QmMassFilterProcessBean[] checkBean,QmMassFilterProcessBean[] processBean,LoginBean login) throws Exception;
