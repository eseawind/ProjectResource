...
public class FaultDataCalc extends Thread{
	...
	public void setFauleData(Map<String, CommonData> dataMap){
		...
		try{
			...
			}else if(type.toUpperCase().equals("ZJ17") || type.toUpperCase().equals("ZJ19") || type.toUpperCase().equals("PROTOS70")){
				//设备类型判断必须要与DAC一致
			...
			}else if(type.toUpperCase().equals("ZB25") || type.toUpperCase().equals("ZB45") || type.toUpperCase().equals("GDX2") || type.toUpperCase().equals("GDX")){
			    try {
					...
					System.out.println("设备故障code："+equipmentID+"  设备类型："+type);
					e.printStackTrace();
				}
			}
