package com.shlanbao.tzsc.pms.qm.better.beans;
 ...
 */
public class BetterManageQueryBean{
	private String id;
	...
	public String getZlTarget() {
		return zlTarget;
	}

	public void setZlTarget(String zlTarget) {
		this.zlTarget = zlTarget;
	}
