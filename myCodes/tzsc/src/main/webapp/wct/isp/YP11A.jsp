...
<script type="text/javascript">
	...
	function getBoxerData(){
		console.info("${loginInfo.equipmentCode}");
	...
	var commonRequestTime=setInterval('getBoxerData()',3000);
...
<div class="info_count">
	<div class="info_count_left fl">
		<!-- 封箱机 -->
		<div class="left_output" style="margin-bottom: 80px;margin-top:20px;">
		...
		<div class="info_count_left_status w384" style="height: 205px;margin-top: 30px;">	
		 ...
		 -->
				<!-- 封箱机故障信息 -->
		<div class="info_count_left_status w384 error" style="height: 295px;">	
			<h1>封箱机故障信息 </h1>
			<div id="error_div">
				<!-- <ul >
					<li>故障信息</li>
