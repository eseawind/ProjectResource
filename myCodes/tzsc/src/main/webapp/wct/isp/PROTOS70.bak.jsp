...
<title>commonRequestTime卷烟机实时监控 ZJ17</title>
<style>
...
/**/
.roller_img{height:311px;border:none;background-image:url(${pageContext.request.contextPath}/wct/isp/img/roller.png);}
...
<script type="text/javascript">
	...
	function initRollerBaseInfo(){
		$.post("${pageContext.request.contextPath}/wct/isp/roller/initRollerBaseInfo.do",{"equipmentCode":"${loginInfo.equipmentCode}"},function(json){
			//
		    ...
		    $("#lvbangBzdh").html(json.lvbangBzdh);  // 1.25
		    $("#juanyanzhiBzdh").html(juanyanzhiBzdh);  // 3060
		    $("#shuisongzhiBzdh").html(shuisongzhiBzdh);  // 1.65
	...
	function getRollerData(){
		$.post("${pageContext.request.contextPath}/wct/isp/roller/getRollerData.do",{"equipmentCode":"${loginInfo.equipmentCode}"},function(json){
			...
			var lvbangVal = json.lvbangVal.toFixed(2);
			var juanyanzhiVal = json.juanyanzhiVal.toFixed(2);
			var shuisongzhiVal = json.shuisongzhiVal.toFixed(2);
		    ...
		    $("#juanyanzhiDh").html((juanyanzhiVal/qty).toFixed(2));
		    $("#shuisongzhiDh").html((shuisongzhiVal/qty).toFixed(2));
		    
		    $("#lvbang_h").css("height",((lvbangVal/qty)/lvbangBzdh*80).toFixed(2)+"%");
		    $("#juanyanzhi_h").css("height",((juanyanzhiVal/qty)/juanyanzhiBzdh*80).toFixed(2)+"%");
		    $("#shuisongzhi_h").css("height",((shuisongzhiVal/qty)/shuisongzhiBzdh*80).toFixed(2)+"%");
	...
	setInterval('getRollerData()',2000);
...
<div class="info_machine">
	...
	<div class="info_machine_left fl">
		<h1 class="fl" id="roller-title">烟支装盘机</h1>
		<div class="fr machine_info">
			<p>设备型号：<span id="roller-sbxh">AAA</span>
			<p>装盘数量：<span id="roller-edcs">888.89</span>盘</p>
		</div>	
	</div>
	<!-- 主机 -->
	...
	<div class="info_machine_right fr">
		<h1 class="fl" id="roller-title">嘴棒接收机</h1>
		<div class="fr machine_info">
			<p>设备型号：<span id="roller-sbxh">BBB</span>
			<p>接收数量：<span id="roller-edcs">888.88</span>万支</p>
		</div>	
	</div>
</div>
<div class="info_area">
...
<div class="info_count">
	<div class="info_count_left fl">
		...
		<!-- 卷烟机 tab -->
		<div class="depictCon" style="width:406px;">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tbody>
					<tr>
						<td class="depictTdC" width="100">滤棒(万支)</td>
						<td class="depictTdC" width="100">卷烟纸(米)</td>
						<td class="depictTdC br_r" width="100">水松纸(米)</td>						
					</tr>
					<tr>
						<td class="depictTdP " >消耗：<span  id="lvbangVal">0</span></td>
						<td class="depictTdP " >消耗：<span  id="juanyanzhiVal">0</span></td>
						<td class="depictTdP " >消耗：<span  id="shuisongzhiVal">0</span></td>						
					</tr>
					<tr>
						<td class="depictTdP ">							
						...
						<td class="depictTdP ">							
							...
							<div class="fl">
								<span  id="juanyanzhiDh" class="data_span">0.0</span>
								<div class="progress-h c_h">
						...
						<td class="depictTdP ">							
							...
							<div class="fl">
								<span  id="shuisongzhiDh" class="data_span">0.0</span>
								<div class="progress-h c_h">
	...
	<div class="info_count_right fl">
		<!-- 烟机图面 -->
		<div class="info_count_left_status w553 roller_img">
			<div id="run_div">
					<div id="run_status">					
