...
if(loginname==null || loginname=="" || loginname.length==0){
	...
	function getFilterData(){
		$.post("${pageContext.request.contextPath}/wct/isp/filter/getFilterDataCX_FL.do",{"equipmentCode":"${loginInfo.equipmentCode}"},function(json){
		    
			var qty = json.qty.toFixed(2);
			$(".qty").html((qty/50000).toFixed(2));// 2.03,
	...
	<div class="info_count_left fl">
		...
		<div class="depictCon" style="width: 266px;margin-left: 68px;">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tbody>
					<tr>
						<td class="depictTdC" width="100">盘纸（千克）</td>
					</tr>
					<tr>
