	...
	function initPackerBaseInfo(){
		$.post("${pageContext.request.contextPath}/wct/isp/packer/initPackerBaseInfo.do",{"equipmentCode":"${loginInfo.equipmentCode}"},function(json){
		   ...
		   //$("#planQty").html(50); 
		    ...
		    $("#xiaohemoBzdh").html(xiaohemoBzdh);//小盒膜标准单耗
			$("#tiaohemoBzdh").html(tiaohemoBzdh);//条盒膜标准单耗
			$("#xiaohezhiBzdh").html(xiaohezhiBzdh);//小盒纸标准单耗
			$("#tiaohezhiBzdh").html(tiaohezhiBzdh);//条盒纸标准单耗
			$("#neichenzhiBzdh").html(neichenzhiBzdh);//内衬纸标准单耗
	...
	function getPackerData(){
		$.post("${pageContext.request.contextPath}/wct/isp/packer/getPackerData.do",{"equipmentCode":"${loginInfo.equipmentCode}"},function(json){
			...
			$("#neichenzhiVal").html(neichenzhiVal);
			 	...
			 	$("#xiaohemoBzdh").text();//小盒膜标准单耗
				$("#tiaohemoBzdh").text();//条盒膜标准单耗
				$("#xiaohezhiBzdh").text();//小盒纸标准单耗
				$("#tiaohezhiBzdh").text();//条盒纸标准单耗
				$("#neichenzhiBzdh").text();//内衬纸标准单耗
