...
<script type="text/javascript">
	...
	$(function(){
		...
		$.post("${pageContext.request.contextPath}/wct/call/callMenu.jsp",function(v){
...
<body>
	<div id="prods-idx">
		<div id="prods-idx-menu"></div>
		  	<div id="prods-idx-content"><iframe id="sch" scrolling="no" frameborder="0" src="${pageContext.request.contextPath}/wct/call/matRequest/matRequest.jsp" style="width:100%;height:100%"></iframe></div>
	</div>
