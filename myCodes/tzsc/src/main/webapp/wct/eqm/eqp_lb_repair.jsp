...
<div id="hid_repair_div"
	style="display: none; height: 368px; width:97%; top: 40px; left: 20px; position: absolute; z-index: 90;"
		...
		<form id="repair-box-wct-frm">
			...
			<div>
				 <!-- <span class="input-group" >
				  ...
				  <select name="fixtype"  id="fixtype" style="height: 40px;border-radius:5px" class="form-control mass-keyboard">
				...
				<span class="input-group" >
				  ...
				  <input name="remark" id="remark" maxlength="1000" style="height: 40px; width:570px; border-radius:5px" class="form-control mass-keyboard"/>
				</span>  -->
			 ...
			 for(var _i=0;_i<value.length;_i++){
				...
				//如果跟换备件  更新备件的数据
					if(flag==1&&tf==0){
						 ...
						 $.post("${pageContext.request.contextPath}/wct/eqm/checkplan/addFixRec.do",{all_id:all_id,use_n:use_n,all_num:all_num,trouble_id:idId,fix_type:0,type:type_});
						 showAddFixResult(tf,flag);
					}else if(tf!=0&&flag==0){
						if(isPass){
							//手动添加备品备件记录
							$.post("${pageContext.request.contextPath}/wct/eqm/fixrec/addNewFix.do",{id:idId,fix_name:trouble_name,fix_code:description,useNum:useNum,type:type_})
							showAddFixResult(tf,flag);
						}else{
