...
/* #eqpRunSta svg{border: 1px solid #9a9a9a; */
	...
	$(function(){
		...
		*/
		...
		var bandParams=function(pageIndex,params){
			$.post("${pageContext.request.contextPath}/wctEqp/listRunSta.action?curpage="+pageIndex,params,function(v){				
				var obj=eval("("+v+")");
...
<body>
<div id="eqpRunSta-title">设备运行统计</div>
	...
	<form id="eqpRunSta-wct-frm">
		<table width="100%" cellspacing="0" cellpadding="0">
			...
			<td style="width:115px;">
				<input style="width:140px;height:20px;"   name="bean.eqpCod" id="eqp"/>
			</td>
			<th style="width:60px;text-align:right;">日期&nbsp;&nbsp;</th>
			<td style="width:140px;">
			<input class="easyui-datebox" editable="false" 
				   style="border:1px solid #9a9a9a;height:20px;width:140px;"
			       name="bean.date"/>
			</td>
...
<div id="eqpRunSta-tab" style="height:462px;overflow:auto;">
	<div id="eqpRunSta" style="min-width: 310px; height: 462px; margin: 0 auto"></div>
</div>
