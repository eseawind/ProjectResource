	...
	$(function(){
	  ...
	  //设置默认日期
		...
		var bandParams=function(pageIndex,params,od){
			$.post("${pageContext.request.contextPath}/wct/stat/getHisBadQtyData.do?eqpCod=${loginInfo.equipmentCode}&orderFlag="+od+"&pageIndex="+pageIndex,params,function(obj){				
				var lables=obj.lables;
				var values=obj.values2;
				var values2=obj.values3;
				var unit=obj.unit;
...
<div id="hisBadQty-title">设备历史剔除</div>
...
<div id="hisBadQty-page">
	<div style="float:left">
	     ...
	     <input id="rej-od" order="5" type="button"  value="剔除排序" class="btn btn-default od"/>
	</div>
