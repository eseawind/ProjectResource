		      ...
		      var editIndex = undefined;
		           ...
		           function endEditing(){
		              ...
		              function accept(){
		                  ...
		                  $.post("${pageContext.request.contextPath}/wctQm/addHzData.action",
		                		 {
		                	      "bean.id":curRow.id,
		                	      "bean.qz":curRow.qz,
		                	      "bean.cz":curRow.cz,
		                		  "bean.yzqx":curRow.yzqx,
		                		  "bean.ncz":curRow.ncz,
		                		  "bean.nkz":curRow.nkz,
		                		  "bean.sbz":curRow.sbz,
		    	    ...
		    	    var loadQmData=function(wkcod){
		    	    	datagrid_hezhuang.datagrid({
		    				url : "${pageContext.request.contextPath}/wctQm/listHzData.action",
		    	    ...
		    	    var deleteData=function(){
		    	    	...
		    	    	if(curRow){
		    	    		jConfirm("确认删除","系统提示",function(v){
		    	    			if(v){
		    	    				$.post("${pageContext.request.contextPath}/wctQm/delHzData.action",
...
<div id="eqpRun-title">包装工序盒装质量自检</div>
