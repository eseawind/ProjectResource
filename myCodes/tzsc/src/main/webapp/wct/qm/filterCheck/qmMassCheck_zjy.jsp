...
<script type="text/javascript">
			...
			$("#czg-tab-tbody tr").die().live("click",function(){
				...
				tr.find("td").each(function(index){
					...
					if(index==5){//处理措施
	                    ...
	                    var se5="<select style='width:50px;height:30px;'>";
				...
				if(data.rows!=null&&data.rows.length>0){
					for(var i=0;i<data.rows.length;i++){
						...
						html+="<tr>"
							...
							+"	<td width='130px'>"+checkCondition+"</td>"	//存在问题
							+"	<td width='110px'>"+revalue.failureNum+"</td>"		//数量
							+"	<td width='56px'>"+failureUom+"</td>"		//单位
							+"	<td width='193px'>"+checkStep+"</td>"		//处理措施
							+"	<td width='85px'>"+addUserName+"</td>" //签名
							+"</tr>";
					}
				}else{}
	...
	function insert(){
		...
		var html="<tr>"
			...
			+"	<td width='130px'>"+se3+"</td>"
			+"	<td width='110px'>"+se4+"</td>"
			+"	<td width='56px'>"+se5+"</td>"
			+"	<td width='193px'>"+se6+"</td>"
			+"	<td width='85px'>"+se7+"</td>"
			+"</tr>";
	...
	<table border="1" borderColor="#9a9a9a"
		...
		<thead id="czg-tab-thead"
			...
			<tr>
				...
				<td width="130px">质量情况</td>
				<td width="110px">不合格数</td>
				<td width="56px;">单位</td>
				<td width="193px;">处理措施</td>
				<td width="85px;">签字</td>
			</tr>
		</thead>
