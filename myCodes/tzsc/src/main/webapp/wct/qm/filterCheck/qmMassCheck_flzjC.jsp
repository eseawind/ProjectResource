				...
				tr.find("td").each(function(index){
	                ...
	                if(index==6){
	                    ...
	                    for(var i=0;i<commentskey.length;i++ ){
	                    	 if(commentskey[i]==oldText||commentsval[i]==oldText){
	                    		 se6+="<option value='"+commentskey[i]+"' selected>"+commentsval[i]+"</option>" ;
	                        }else{
	                        	se6+="<option value='"+commentskey[i]+"' >"+commentsval[i]+"</option>";
	                        }
	                    }
	                    se6+="</select>"; 
	                   $(this).html(se6);
	...
	function flzjSearch(){
		...
		$.post("${pageContext.request.contextPath}/wct/massExcipient/getList.do",params,function(v){
				...
				$("#flzj-tab-tbody tr").each(function(idx){
						...
						tr.find("td:eq(0)").html("<input value='"+revalue.qmExcipientId+"' style='width:20px;height:20px;' type='checkbox' name='flzj-tab-tbody-CK' id='flzj-tab-tbody-CK'/>");				
	...
	<table border="1" borderColor="#9a9a9a"
		...
		<thead id="flzj-tab-thead"
			...
			<tr>
				...
				<td width="65px">序号</td>
				<td width="132px">检查项目</td>
				<td width="130px">检查频率</td>
				<td width="130px">检查时间</td>
				<td width="130px">检查判定</td>
				<td width="163px">不合格情况</td>
			</tr>
		</thead>
		<tbody id="flzj-tab-tbody">
			<tr>
				<td width="40">
					<input value="" id="flzj-tab-tbody-CK" name="flzj-tab-thead-CK" type="checkbox"/></td>
				</td>
				<td width="65px">1</td>
				<td width="132px">接班<br/>辅料确认</td>
				<td width="130px">每班<br/>接班</td>
				<td width="130px"></td>
				<td width="130px">对</td>
				<td width="163px">无需填写</td>
			</tr>
			<tr>
				<td width="40">
					<input value="" id="flzj-tab-tbody-CK" name="flzj-tab-thead-CK" type="checkbox"/></td>
				...
				<td width="65px">2</td>
				<td width="132px">班中接收<br/>辅料确认</td>
				<td width="130px">班中接<br/>收辅料</td>
				<td width="130px"></td>
				<td width="130px">对</td>
				<td width="163px">无需填写</td>
			</tr>
			<tr>
				...
				<td width="65px">3</td>
				<td width="132px">接头检测</td>
				<td width="130px">接班两<br/>小时内</td>
				<td width="130px"></td>
				<td width="130px">对</td>
				<td width="163px">无需填写</td>
			</tr>
