	...
	$(function(){
		...
		var bandParams=function(params){
			$.post("${pageContext.request.contextPath}/wct/stat/initOutDataByEqp.do",params,function(v){				
				...
				$('#matId').html(v.matId);
				$('#QmCheckEquCode').html(v.eqpCod);//设备code
...
<body>
	...
	<div id="wkd-qua-title">操作工首检</div>
	<div id="wkd-qua-msg-title">
		<table style="font-size: 14px;">
			<tr>
				...
				<td width="10"></td>
				<td><!-- <b>自检人:</b></td><td><div style="color:green;" id="massCheckZjr">...</div> --></td>
				<td><b>状态:</b></td><td><div style="color:green;" id="massCheckZt">...</div></td>
				...
				<td><div style="display:none;" id="QmCheckEquCode"></div></td>
			</tr>
		</table>
	</div>
	<!-- 顶端tab布局 -->
		...
		<div class="info_machine_cen fl">
			<ul class="nav nav-tabs" id="tabs" style="width: 900px;">
			 	<li><a href="#" name="#tab1" class="tab_1">首检记录</a></li>
			  	...
			  	<div id="button_show1" style="float:left;width:80px;height:34px;">登录</div> 
			  </ul>		
		</div>
	</div>
	<!-- 内容 -->
		...
		<div id="tab2" class="xhtj">
			<div class="info_status" >
				<div class="single_info_v" id="scroll_box2">
					<script>document.write(remark_wirte_pack);</script>
				</div>
			</div>					
		</div>
	</div>	
