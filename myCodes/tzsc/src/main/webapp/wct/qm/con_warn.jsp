...
<script type="text/javascript">
	...
	$(function(){
		 bandParams=function(pageIndex,params){
			...
			$.post("${pageContext.request.contextPath}/wct/msg/carn/getConWarnList.do?pageIndex="+pageIndex,params,function(reobj){
			...
			var list=reobj.rows;
				...
				$("#prodMailPlan-tab-tbody tr").each(function(idx){
						if(list.length>idx){
							...
							tr.find("td:eq(4)").html(revalue.item);
							tr.find("td:eq(5)").html(revalue.std);
							tr.find("td:eq(6)").html(revalue.val);
	...
	function completes(id){
		$.post("${pageContext.request.contextPath}/wct/msg/carn/getConUpdate.do?id="+id,function(json){
			...
			<table border="1" borderColor="#9a9a9a" style="BORDER-COLLAPSE:collapse;font-size: 12px;font-weight: 500;" width="824" height="474" cellspacing="0" cellpadding="0">
				<thead id="prodMailPlan-tab-thead" style="background: #5a5a5a;color: #fff;">
					<tr>
						...
						<td class="t-header" style="width:80px">辅料名称</td>
						<td class="t-header" style="width:80px">额定单耗</td>
						<td class="t-header" style="width:150px">当前单耗</td>
