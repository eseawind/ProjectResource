...
<body>
	...
	<div id="wkd-qua-title">过程自检记录</div>
	<div id="wkd-qua-msg-title">
		<table style="font-size: 14px;">
			<tr>
				<td>&nbsp;&nbsp;<b>班次：</b></td><td><div id="massCheckBc"></div></td>
				<td><b>&nbsp;机台名：</b></td>			<td><div id="massCheckJth"></div></td>
	...
	<div class="info_machine">	
		<div class="info_machine_cen fl">
			<ul class="nav nav-tabs" id="tabs" style="width: 900px;">
				<li><a href="#" name="#tab2" class="tab_1" style="width:90px">过程自检记录</a></li>
			  	<li><a href="#" name="#tab6" class="tab_2">填写说明</a></li> 
		...
		<div id="tab6" class="xhtj">
			<div class="info_status" >
				<div class="single_info_v" id="scroll_box6">
					<script>document.write(remark_wirte);</script>
				</div>
			</div>					
		</div>
	</div>	
