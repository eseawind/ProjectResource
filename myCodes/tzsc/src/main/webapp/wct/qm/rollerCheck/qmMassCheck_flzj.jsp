			...
			$("#flzj-tab-tbody tr").die().live("click",function(){
				...
				tr.find("td").each(function(index){
	                ...
	                if(index==6){
	                    ...
	                    for(var i=0;i<notFitKey.length;i++ ){
	                    	 if(notFitKey[i]==oldText||notFitVal[i]==oldText){
	                    		 se6+="<option value='"+notFitKey[i]+"' selected>"+notFitVal[i]+"</option>" ;
	                        }else{
	                        	se6+="<option value='"+notFitKey[i]+"' >"+notFitVal[i]+"</option>";
	                        }
	                    }
	                    se6+="</select>"; */
	                   /* var se6="<input type='text' value='"+oldText+"'  style='width:100px;'></input>";
	                   $(this).html(se6); */
	                }
	            }); 
	        });
