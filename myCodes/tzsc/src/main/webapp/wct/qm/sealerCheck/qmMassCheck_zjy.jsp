...
<script type="text/javascript">
				...
				if(data.rows!=null&&data.rows.length>0){
					for(var i=0;i<data.rows.length;i++){
						...
						html+="<tr>"
							...
							+"	<td width='94px'>"+checkTime+"</td>"
							+"	<td width='146px'>"+checkCondition+"</td>"	//存在问题
							+"	<td width='126px'>"+revalue.failureNum+"</td>"		//数量
							+"	<td width='65px'>"+failureUom+"</td>"		//单位
							+"	<td width='158px'>"+checkStep+"</td>"		//处理措施
							+"	<td width='94px'>"+addUserName+"</td>" //签名
							+"</tr>";
					}
				}else{}
	...
	function insert(){
		...
		var html="<tr>"
			...
			+"	<td width='94px'>"+nowDate+"</td>"
			+"	<td width='146px'>"+se3+"</td>"
			+"	<td width='126px'>"+se4+"</td>"
			+"	<td width='65px'>"+se5+"</td>"
			+"	<td width='158px'>"+se6+"</td>"
			+"	<td width='94px'>"+se7+"</td>"
			+"</tr>";
	...
	<table border="1" borderColor="#9a9a9a"
		...
		<thead id="czg-tab-thead"
			...
			<tr>
				...
				<td width="60px">序号</td>
				<td width="94px">时间</td>
				<td width="146px">质量情况</td>
				<td width="126px">不合格数</td>
				<td width="65px">单位</td>
				<td width="158px">处理措施</td>
				<td width="94px">签字</td>
			</tr>
		</thead>
