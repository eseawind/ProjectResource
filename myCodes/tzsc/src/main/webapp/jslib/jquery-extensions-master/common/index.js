...
(function ($) {
    ...
    var homePageTitle = "主页", homePageHref = null, navMenuList = "#navMenu_list",
        ...
        btnContact = "#btnContact", btnFullScreen = "#btnFullScreen";
    ...
    window.mainpage.loadNavMenus = function (callback) {
        ...
        $.get("/TZ/webapp/initlib/jquery-extensions-master/common/nav-menu-data.json", function (menus) {
