	...
	$(function() {
		$("#uploader").pluploadQueue({
			...
			filters : [ {
				...
				title : 'Office files',
				/* extensions : 'doc,docx,excel,ppt,txt,mpp,xls,pdf' */
				extensions : 'pdf,txt'
			}, {
				title : 'exe files',
				extensions : 'exe,bit'
			...
			if (uploader.files.length > 0) {// 判断队列中是否有文件需要上传
				uploader.bind('StateChanged', function() {// 在所有的文件上传完毕时，提交表单
					if (uploader.files.length === (uploader.total.uploaded + uploader.total.failed)) {
						console.info(uploader.files.length+" = "+uploader.total.failed);
						$('form')[0].submit();
					}
				});
				uploader.start();
		...
		<table width="100%">
			...
			<tr>
				...
				<td style="display: none;">
				 ...
				 <td></td>
				 <td style="display: none;">版本号:
				 <input name="procVersion" maxlength="50" value="1.0"
