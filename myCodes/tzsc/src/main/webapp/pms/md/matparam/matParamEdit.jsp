			...
			<fieldset>
				...
				<table class="table" style="width: 100%;">
					<tr>
						<th>辅料</th>
						<td>
							<input name="id" type="hidden" value="${matParam.id}"/> 
							<input id="matName"  name="matName" class="easyui-searchbox"  
							value="${matParam.matName}"
							data-options="prompt: '请选择辅料',required:true"/>  
							<input id="mat" name="mat" type="hidden" value="${matParam.mat}"/> 
						</td>
						<th>系数</th>
						<td>
