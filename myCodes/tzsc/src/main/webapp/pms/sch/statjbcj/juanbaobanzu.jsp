...
<script type="text/javascript">
		...
		$(function() {
			...
			passRateGrid = $('#passRateGrid').datagrid({
				...
				columns : [  [ 
						...
						{title :'实际产量(箱)',formatter:function(value,row,index){return Math.round(value*100)/100},rowspan:2,field : 'qty',width :$(this).width() * 0.07,align:'center',sortable : true},
						//{title :'产量单位',rowspan:2,field : 'mdUnitName',width :$(this).width() * 0.06,align:'center',sortable : true},
						{title :'剔除(箱)',formatter:function(value,row,index){return Math.round(value*100)/100},rowspan:2,field : 'badQty',width :$(this).width() * 0.07,align:'center',sortable : true},
						{title:'滤棒',colspan:2},
						{title:'滤棒盘纸',colspan:2},
						{title:'水松纸',colspan:2},
						{title :'实际产量(箱)',formatter: function(value,row,index){return Math.round(value*100)/100},rowspan:2,field : 'qtyBaoZhuang',width :$(this).width() * 0.07,align:'center',sortable : true},
						//{title :'产量单位',rowspan:2,field : 'mdUnitNameBad',width :$(this).width() * 0.06,align:'center',sortable : true},
						{title :'剔除(箱)',formatter: function(value,row,index){return Math.round(value*100)/100},rowspan:2,field : 'badQtyBaoZhuang',width :$(this).width() * 0.07,align:'center',sortable : true},
						{title:'小盒',colspan:2},
						...
						{title :'消耗(支)',formatter:function(value,row,index){return Math.round(value*100)/100},rowspan:1,field : 'qty1',width :$(this).width() * 0.07,align:'center',sortable : true},
						//{title : '单位',rowspan:1,field : 'mdUnitName1',width :$(this).width() * 0.05,align:'center',sortable : true},
						{title : '单耗(支/箱)',rowspan:1,field : 'danhao1',align:'center',sortable : true},
						{title :'消耗(米)',formatter:function(value,row,index){return Math.round(value*100)/100},rowspan:1,field : 'qty2',width :$(this).width() * 0.07,align:'center',sortable : true},
						//{title : '单位',rowspan:1,field : 'mdUnitName2',width :$(this).width() * 0.05,align:'center',sortable : true},
						{title : '单耗(米/箱)',rowspan:1,field : 'danhao2',align:'center',sortable : true},
						...
						{title : '单耗(KG/箱)',rowspan:1,field : 'danhao3',align:'center',sortable : true},
						
						{title : '消耗(张)',formatter:function(value,row,index){return Math.round(value*100)/100},rowspan:1,field : 'qty4',width :$(this).width() * 0.07,align:'center',sortable : true},
						//{title : '单位',rowspan:1,field : 'mdUnitName4',width :$(this).width() * 0.05,align:'center',sortable : true},
						{title : '单耗(张/箱)',rowspan:1,field : 'danhao4',align:'center',sortable : true},
						...
						{title : '消耗(KG)',formatter:function(value,row,index){return Math.round(value*100)/100},rowspan:1,field : 'qty6',width :$(this).width() * 0.07,align:'center',sortable : true},
						//{title : '单位',rowspan:1,field : 'mdUnitName6',width :$(this).width() * 0.05,align:'center',sortable : true},
						{title : '单耗(KG/箱)',rowspan:1,field : 'danhao6',align:'center',sortable : true},
						
						{title : '消耗(张)',formatter: function(value,row,index){return Math.round(value*100)/100},rowspan:1,field : 'qty7',width :$(this).width() * 0.07,align:'center',sortable : true},
						//{title : '单位',rowspan:1,field : 'mdUnitName7',width :$(this).width() * 0.05,align:'center',sortable : true},
						{title : '单耗(张/箱)',rowspan:1,field : 'danhao7',align:'center',sortable : true},
						{title : '消耗(KG)',formatter:function(value,row,index){return Math.round(value*100)/100},rowspan:1,field : 'qty8',width :$(this).width() * 0.07,align:'center',sortable : true},
						//{title : '单位',rowspan:1,field : 'mdUnitName8',width :$(this).width() * 0.05,align:'center',sortable : true},
						{title : '单耗(KG/箱)',rowspan:1,field : 'danhao8',align:'center',sortable : true},
		...
		function getShapes() {
		    ...
		    if(date1!=null&date1!=""&&date2!=null&date2!=""){
		    	passRateGrid.datagrid({
					url : tempUrl+"/getAllJuanBaoBanZu.do",
	...
	//passRateGrid("loadData",$("#passRateForm").form("getData"));
	   ...
	   //导出execl
	   function derive(){
		   var recordUrl =tempUrl+"/excelDeriveJuanBaoBZ.do?mdTeamId="+$("#passRateForm").form("getData").mdTeamId+"&mdShiftId="+$("#passRateForm").form("getData").mdShiftId+"&stim="+$("#passRateForm").form("getData").stim+"&etim="+$("#passRateForm").form("getData").etim;
		   var isPass=false;
		   var queryExcel=tempUrl+"/queryExcelDeriveJuanBaoBZ.do?mdTeamId="+$("#passRateForm").form("getData").mdTeamId+"&mdShiftId="+$("#passRateForm").form("getData").mdShiftId+"&stim="+$("#passRateForm").form("getData").stim+"&etim="+$("#passRateForm").form("getData").etim;
