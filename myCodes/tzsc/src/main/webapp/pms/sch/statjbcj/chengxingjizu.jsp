...
<script type="text/javascript">
		...
		function getShapes() {
		    ...
		    if(date1!=null&date1!=""&&date2!=null&date2!=""){
		    	passRateGrid.datagrid({
					url : tempUrl+"/getAllChengXingJiZu.do",
	...
	//passRateGrid("loadData",$("#passRateForm").form("getData"));
	   ...
	   function derive(){
		   var isPass=false;
			var recordUrl=tempUrl+"/excelDeriveChengXingJiZu.do?mdEquipmentId="+$("#passRateForm").form("getData").mdEquipmentId+"&stim="+$("#passRateForm").form("getData").stim+"&etim="+$("#passRateForm").form("getData").etim;
			var queryExcel=tempUrl+"/queryExcelDeriveChengXingJiZu.do?mdEquipmentId="+$("#passRateForm").form("getData").mdEquipmentId+"&stim="+$("#passRateForm").form("getData").stim+"&etim="+$("#passRateForm").form("getData").etim;
