...
<script type="text/javascript">
		...
		$(function() {
			...
			passRateGrid = $('#passRateGrid').datagrid({
				...
				columns : [  [ 
								...
								{title:'成型机组',colspan:12},
								
							],[ 
								{title :'产量',rowspan:2,field : 'qty',width :$(this).width() * 0.07,align:'center',sortable : true},
								
								{title : '单位',rowspan:2,field : 'mdUnitName',width :$(this).width() * 0.05,align:'center',sortable : true},
								{title : '剔除',rowspan:2,field : 'badQty',width :$(this).width() * 0.05,align:'center',sortable : true},
								{title:'盘纸',colspan:3},
								{title:'甘油',colspan:3},
								{title:'丝束',colspan:3},
						...
						{title :'消耗',rowspan:1,field : 'qty1',width :$(this).width() * 0.08,align:'center',sortable : true},
						{title : '单位',rowspan:1,field : 'mdUnitName1',width :$(this).width() * 0.08,align:'center',sortable : true},
						{title : '单耗',rowspan:1,field : 'danhao1',width :$(this).width() * 0.08,align:'center',sortable : true},
						{title :'消耗',rowspan:1,field : 'qty2',width :$(this).width() * 0.08,align:'center',sortable : true},
						{title : '单位',rowspan:1,field : 'mdUnitName2',width :$(this).width() * 0.08,align:'center',sortable : true},
						{title : '单耗',rowspan:1,field : 'danhao2',width :$(this).width() * 0.08,align:'center',sortable : true},
						{title : '消耗',rowspan:1,field : 'qty3',width :$(this).width() * 0.08,align:'center',sortable : true},
						{title : '单位',rowspan:1,field : 'mdUnitName3',width :$(this).width() * 0.08,align:'center',sortable : true},
						{title : '单耗',rowspan:1,field : 'danhao3',width :$(this).width() * 0.08,align:'center',sortable : true},
		...
		function getShapes() {
		    ...
		    if(date1!=null&date1!=""&&date2!=null&date2!=""){
		    	passRateGrid.datagrid({
					url : tempUrl+"/getAllChengXingChanPin.do",
	...
	//passRateGrid("loadData",$("#passRateForm").form("getData"));
	   ...
	   //导出execl
	   function derive(){
			var recordUrl =tempUrl+"/excelDeriveChengXingChanPin.do?mdTeamId="+$("#passRateForm").form("getData").mdTeamId+"&mdShiftId="+$("#passRateForm").form("getData").mdShiftId+"&stim="+$("#passRateForm").form("getData").stim+"&etim="+$("#passRateForm").form("getData").etim;
			var isPass=false;
			var queryExcel=tempUrl+"/queryExcelDeriveChengXingChanPin.do?mdTeamId="+$("#passRateForm").form("getData").mdTeamId+"&mdShiftId="+$("#passRateForm").form("getData").mdShiftId+"&stim="+$("#passRateForm").form("getData").stim+"&etim="+$("#passRateForm").form("getData").etim;
