...
<script type="text/javascript">
		...
		$(function() {
			...
			passRateGrid = $('#passRateGrid').datagrid({
				...
				frozenColumns:[[//固定表头
						...
						{title:'牌号', rowspan:3,field:'mdMatName',width:150,align:'center'},//跨列
				...
				columns : [  [ 
						...
						{title :'实际产量',rowspan:2,field : 'qty',width :$(this).width() * 0.09,align:'center',sortable : true},
						{title :'产量单位',rowspan:2,field : 'mdUnitName',width :$(this).width() * 0.09,align:'center',sortable : true},
						{title :'剔除',rowspan:2,field : 'badQtyBaoZhuang',width :$(this).width() * 0.09,align:'center',sortable : true},
						{title:'盘纸',colspan:3},
						{title:'甘油',colspan:3},
						{title:'丝束',colspan:3},
	...
	//passRateGrid("loadData",$("#passRateForm").form("getData"));
	   ...
	   function derive(){
		   var isPass=false;
		   var recordUrl =tempUrl+"/excelDeriveChengXingCheJian.do?mdTeamId="+$("#passRateForm").form("getData").mdTeamId+"&mdShiftId="+$("#passRateForm").form("getData").mdShiftId+"&stim="+$("#passRateForm").form("getData").stim+"&etim="+$("#passRateForm").form("getData").etim;
		   var queryExcel =tempUrl+"/queryExcelDeriveChengXingCheJian.do?mdTeamId="+$("#passRateForm").form("getData").mdTeamId+"&mdShiftId="+$("#passRateForm").form("getData").mdShiftId+"&stim="+$("#passRateForm").form("getData").stim+"&etim="+$("#passRateForm").form("getData").etim;
