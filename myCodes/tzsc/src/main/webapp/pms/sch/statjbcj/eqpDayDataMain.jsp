...
<script type="text/javascript">
	...
	function exportExcel(){
		...
		var tempUrl ="${pageContext.request.contextPath}/pms/sch/statjbcj/exportDayQtyData.do";
...
<body class="easyui-layout panel-body" data-options="fit : true,border : false">
	...
	<div data-options="region:'center',border:false">
		<iframe id="checkJsp" name="checkJsp" src="eqpDayData.jsp" width="100%" height="99%" allowtransparency="yes" frameborder="no" border="0" marginwidth="0" marginheight="0" ></iframe>
	</div>
