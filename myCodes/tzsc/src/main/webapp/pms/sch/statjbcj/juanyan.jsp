...
<script type="text/javascript">
	...
	//passRateGrid("loadData",$("#passRateForm").form("getData"));
	   ...
	   function derive(){
					...
					var recordUrl =tempUrl+"/excelDeriveJuanYanZH.do?mdEquipmentId="+$("#passRateForm").form("getData").mdEquipmentId+"&stim="+$("#passRateForm").form("getData").stim+"&etim="+$("#passRateForm").form("getData").etim;
