...
<script type="text/javascript">
			...
			passRateGrid = $('#passRateGrid').datagrid({
				...
				columns : [  [ 
					...
					/* 	{title :'数据最后接收时间',rowspan:2,field : 'lastRecvTime',width :$(this).width() * 0.065,align:'center',sortable : true}, */
						...
						{title : '消耗',rowspan:1,field : 'qty4',width :$(this).width() * 0.07,align:'center',sortable : true},
						{title : '单位',rowspan:1,field : 'mdUnitName4',width :$(this).width() * 0.05,align:'center',sortable : true},
						{title : '单耗',rowspan:1,field : 'danhao4',width :$(this).width() * 0.05,align:'center',sortable : true},
						{title : '消耗',rowspan:1,field : 'qty5',width :$(this).width() * 0.07,align:'center',sortable : true},
						{title : '单位',rowspan:1,field : 'mdUnitName5',width :$(this).width() * 0.05,align:'center',sortable : true},
						{title : '单耗',rowspan:1,field : 'danhao5',width :$(this).width() * 0.05,align:'center',sortable : true},
	   ...
	   //查询
		function getShapes() {
			passRateGrid.datagrid({
				url : tempUrl+"/getAllbaozhuang.do",
	...
	//passRateGrid("loadData",$("#passRateForm").form("getData"));
	   ...
	   function derive(){
					...
					var recordUrl =tempUrl+"/excelDeriveBaoZhuangZH.do?mdEquipmentId="+$("#passRateForm").form("getData").mdEquipmentId+"&stim="+$("#passRateForm").form("getData").stim+"&etim="+$("#passRateForm").form("getData").etim;
