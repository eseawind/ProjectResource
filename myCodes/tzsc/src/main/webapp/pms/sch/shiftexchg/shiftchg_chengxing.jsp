		...
		*/	
		...
		function goToExchgAddJsp(){
			var dialog = parent.$.modalDialog({
				...
				width : 640,
				height : 440,
				href : '${pageContext.request.contextPath}/pms/shiftexchg/goToExchgAddJsp.do?workshop=2&type=1',//workshop 1卷包车间 2成型车间   //type     1换班  2 换牌
				buttons : [ {
					text : '保存',
			...
			<form id="exchgForm" style="margin:4px 0px 0px 0px">
				<div class="topTool">
					...
					<div >
						...
						<input type="hidden" name="workshop" value="2"/><!-- 1卷包 2成型 -->
