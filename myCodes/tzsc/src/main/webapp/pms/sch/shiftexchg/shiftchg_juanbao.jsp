...
<body class="easyui-layout" data-options="fit : true,border : false">
	<div data-options="region:'north',border:false,split:true,title:'换班记录'" style="height:320px;">
		<div id="exchgToolbar"  style="display: none;width:100%;">
			<form id="exchgForm" style="margin:4px 0px 0px 0px">
				<div class="topTool">
					<fieldset >
					<div >
						<input type="hidden" name="type" value="1"/><!-- 1换班 2换牌 -->
					...
					<div >
						<span class="label">交班牌号：</span>
						<select id="hoMat" name="hoMat" class="easyui-combobox" data-options="panelHeight:150,width:100,editable:false"></select>
					</div>
					<div >
					...
					<div >
						<span class="label">接班牌号：</span>
						<select id="toMat" name="toMat" class="easyui-combobox" data-options="panelHeight:150,width:100,editable:false"></select>
					</div>
