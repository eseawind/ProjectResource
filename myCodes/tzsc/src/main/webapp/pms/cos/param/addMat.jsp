			...
			<fieldset>
				...
				<table class="table" style="width: 100%;">
					<tr>
						<th>设备型号</th>
						<td>
							<input type="text" id="categoryId" name="mdEqpTypeId" class="easyui-combobox easyui-validatebox" 
						...
						<td>
							...
							<input id="mat" name="mdMatId" type="hidden" value="" />
						</td>
					</tr>
					<tr>
						<th>奖罚单价</th>
						<td colspan="3">
							<input type="text" name="award" class="easyui-numberbox" data-options="required:true,prompt:'请输入数字'"/>
						</td>
					</tr>
				</table>
			</fieldset>
