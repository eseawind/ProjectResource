			...
			<fieldset>
				...
				<table class="table" style="width: 100%;">
					...
					<tr>
						<th>系数</th>
						<td colspan="3">
							<input type="text" style="width:300px;" name="modulus" id="modulus" precision="4"  min="-99999.99" max="99999.99" class="easyui-numberbox" data-options="required:true,prompt:'请输入系数'" value="${bean.modulus}"/>
						</td>
					</tr>
					<tr>
						<th>备注</th>
						<td colspan="3">
							<textarea style="width:300px;height:50px;resize:none" name="remark">${bean.remark}</textarea>
						</td>
					</tr>
				</table>
			</fieldset>
