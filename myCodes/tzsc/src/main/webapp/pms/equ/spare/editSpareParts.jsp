				...
				<table class="table" style="width:97%;">
					<tr>
						...
						<td>
							...
							<input type="text" name="attr1" id="attr1" readonly="readonly" easyui-validatebox" data-options="required:true" value="${bean.attr1}"/>
						</td>
						<th>名称</th>
						<td>
					...
					<tr>
						<th>单位</th>
						<td>
							<select id="unitId" name="unitId" data-options="panelHeight:200,width:175,editable:false,required:true"><option value ="${bean.unitId}">${bean.unitId}</option></select>
						</td>
						<th>机型</th>
						<td>
					...
					<tr>
						...
						<th>单价</th>
						<td>
							<input type="text" name="price" id="price" precision="4"  min="-99999.99" max="99999.99" class="easyui-numberbox" data-options="required:true,prompt:'请输入系数'" value="${bean.price}"/>
						</td>
					</tr>
					<tr>
						<th>数量</th>
						<td>
							<input type="text" name="attr2" id="attr2" min="-99999" max="99999" precision="0" class="easyui-numberbox" required="required" onkeyup='checkInput(this)' value="${bean.attr2}"/>
						</td>
						<th>备注</th>
						<td colspan="3">
