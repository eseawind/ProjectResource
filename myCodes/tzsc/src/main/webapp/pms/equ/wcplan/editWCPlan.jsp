...
<script type="text/javascript">
	...
	var metcId = $('#metcId').val();//根据绑定的 保养ID来锁定 已选的 规则
	$(function() {
	...
	//首次加载 这里为什么会查询2次呢?
	//根据设备型号 加载绑定的项
	var beanQuery ={queryEqpTypeId : equipmentXhId,queryType:'lb'};//设备型号ID
			...
			<form id="form" method="post">
				<fieldset>
					...
					<tr>
						...
						<td>
						<input name="planName" id="planName" style="width:140px" class="easyui-validatebox" 
						...
						<td>
							...
							data-options="panelHeight:'auto',required:true" >
								<option value="lb" <c:if test="${wcpBean.maintenanceType=='lb' }">selected="selected"</c:if>>轮保</option>
							</select>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							data-options="panelHeight:'auto',width:140,editable:false,required:true" 
