			...
			<fieldset>
				...
				<table class="table" style="width: 100%;">
					<tr>
						<th>轮保计划编号</th>
						<td>	
							<input name="planNo" type="hidden"  value="${randNo }"/>${randNo }
						</td>
						<th>轮保计划名称</th>
						<td>
					...
					<tr>
						<th>设备名称</th>
						<td>
							<input id="equipmentName"  class="easyui-searchbox"  data-options="prompt:'请选择卷烟机或成型机',required:true" value="${wcpBean.eqmName }"/>  
					...
					<tr>
						...
						<th>班次</th>
						<td>
							<input id="shiftId" name="mdShiftId" type="text" data-options="required:true" readonly="readonly" style="width:140px" value="${wcpBean.mdShiftId }"/>
						</td>
						<th></th>
						<td></td>
					</tr>	
