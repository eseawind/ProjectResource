	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding:5px">
			<fieldset>
				...
				<table class="table" style="width:97%;">
					...
					<p><img id='img' src="${pageContext.request.contextPath }/pms/equ/overhaul/excel_Model_img/jianxiu.png" /></p>
					<div  style="color:red;">
	...
	if (file == '' || file == null) {
		...
		if (index < 0) {
			...
			if (ext == "xls" || ext=="xlsx") {
				...
				$('#filesForm').form({   
				    url:"${pageContext.request.contextPath}/pms/overhaul/inputExeclAndReadWrite.do?id="+Math.random(),   
