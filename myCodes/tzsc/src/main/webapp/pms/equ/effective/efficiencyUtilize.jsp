...
<script type="text/javascript">
		...
		*/
		function queryTrouble() {
			dataGrid.datagrid({
				url : "${pageContext.request.contextPath}/pms/effect/queryUtilizeEffective.do",
			...
			var f = $('#searchForm');
			$.post("${pageContext.request.contextPath}/pms/effect/queryUtilizeEffectiveChart.do",f.form("getData"),function(obj){
...
<body class="easyui-layout" data-options="fit : true,border : false">
	...
	<div data-options="region:'center',border:true,split:true,title:'运行效率统计'" style="height: 100%;width:100%">
