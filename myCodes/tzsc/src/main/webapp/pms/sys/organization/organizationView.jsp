...
<title>采用GOJS的机构管理</title>
<jsp:include page="../../../initlib/initAll.jsp"></jsp:include>
<script src="${pageContext.request.contextPath}/jslib/gojs/go.release.js"></script> 
...
<script id="code">
	function init() {
		if(browser.isIe&&browser.ieVersion<9){
			window.location.replace("${pageContext.request.contextPath}/pms/sys/organization/organization.jsp");
		}
