...
<script type="text/javascript">
	...
	var unAssignGrid;
	var assignedGrid;
	var checkedRoleId =	"${checkedRoleId}";
	$(function() {
		unAssignGrid = $('#unAssignGrid').datagrid({
			url:"${pageContext.request.contextPath}/pms/sysRole/getRoleUnAssignedUsers.do?oid=${checkedRoleId}",
			fit : true,
			fitColumns : true,
			border : false,
			pagination : false,
		 ...
		 assignedGrid = $('#assignedGrid').datagrid({
			url:"${pageContext.request.contextPath}/pms/sysRole/getRoleAssignedUsers.do?oid=${checkedRoleId}",
			fit : true,
			fitColumns : true,
			border : false,
			pagination : false,
