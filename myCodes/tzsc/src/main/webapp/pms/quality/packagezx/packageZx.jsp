...
<script type="text/javascript">
		...
		$(function() {
			...
			//end
			packageZxGrid = $('#packageZxGrid').datagrid({
				fit : true,
...
<body class="easyui-layout" data-options="fit : true,border : false">
	...
	<div id="packageZxToolbar" style="display: none;">
		...
		<div class="easyui-toolbar">
			<c:if test="${not empty sessionInfo.resourcesMap['/pms/packageZx/getList.do']}">
				<a onclick="getList();" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-standard-zoom',plain:true">查询</a>
			</c:if>
			 <c:if test="${not empty sessionInfo.resourcesMap['/pms/packageZx/cleanQuery.do']}">
	...
	<div data-options="region:'center',border:false,split:false,title:''">
		<table id="packageZxGrid"></table>		
	</div>
	
	
	<!-- 右键功能 -->
	<div id="packageZxMenu" class="easyui-menu" style="width: 80px; display: none;">
	</div>
