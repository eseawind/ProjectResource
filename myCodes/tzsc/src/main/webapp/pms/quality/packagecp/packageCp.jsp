...
<script type="text/javascript">
		...
		$(function() {
			...
			//end
			packageCpGrid = $('#packageCpGrid').datagrid({
				fit : true,
...
<body class="easyui-layout" data-options="fit : true,border : false">
	...
	<div id="packageCpToolbar" style="display: none;">
		...
		<div class="easyui-toolbar">
			<c:if test="${not empty sessionInfo.resourcesMap['/pms/packageCp/getList.do']}">
				<a onclick="getList();" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-standard-zoom',plain:true">查询</a>
			</c:if>
			 <c:if test="${not empty sessionInfo.resourcesMap['/pms/packageCp/cleanQuery.do']}">
	...
	<div data-options="region:'center',border:false,split:false,title:''">
		<table id="packageCpGrid"></table>		
	</div>
	
	
	<!-- 右键功能 -->
	<div id="packageCpMenu" class="easyui-menu" style="width: 80px; display: none;">
	</div>
