...
<script type="text/javascript">
		...
		$(function() {
			...
			//end
			moldingZxGrid = $('#moldingZxGrid').datagrid({
				fit : true,
...
<body class="easyui-layout" data-options="fit : true,border : false">
	...
	<div id="moldingZxToolbar" style="display: none;">
		...
		<div class="easyui-toolbar">
			<c:if test="${not empty sessionInfo.resourcesMap['/pms/moldingZx/getList.do']}">
				<a onclick="getList();" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-standard-zoom',plain:true">查询</a>
			</c:if>
			 <c:if test="${not empty sessionInfo.resourcesMap['/pms/moldingZx/cleanQuery.do']}">
	...
	<div data-options="region:'center',border:false,split:false,title:''">
		<table id="moldingZxGrid"></table>		
	</div>
	
	
	<!-- 右键功能 -->
	<div id="moldingZxMenu" class="easyui-menu" style="width: 80px; display: none;">
	</div>
