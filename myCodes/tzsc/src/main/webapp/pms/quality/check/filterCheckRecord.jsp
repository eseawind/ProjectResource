...
<script type="text/javascript">
	$(function(){
		...
		$.loadComboboxData($("#mdEqmentId"),"ALLFILTERS",true);
	...
	function exportExcel(){
		var tempUrl ="${pageContext.request.contextPath}/pms/massCheck/exportFilterCheckDataList.do";
...
<body class="easyui-layout panel-body" data-options="fit : true,border : false">
		...
		<form id="searchForm" style="margin:4px 0px 0px 0px;">
			<div class="topTool">
				<fieldset >
					...
					<select id="mdEqmentId" name="mdEqmentId" class="easyui-combobox" data-options="panelHeight:'auto',width:100,editable:false"></select>
					</div>
					<div >
	...
	<div data-options="region:'center',border:false">
		<iframe id="checkJsp" name="checkJsp" src="filterCheck.jsp" width="100%" height="99%" allowtransparency="yes" frameborder="no" border="0" marginwidth="0" marginheight="0" ></iframe>
	</div>
