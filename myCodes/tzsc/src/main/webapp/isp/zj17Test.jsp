...
*{margin:0;padding:0;font-size: 12px;font-family: "Microsoft YaHei","微软雅黑","宋体",Arial;}
	...
	.info_machine_left{ width:14.3%;height:64px;background:#c0c0c0;border:1px solid #aaaaaa;}
...
<div id="body-center" style="width:1960px;height:1000px;background-color: #D6D6D6;">
<div class="info_machine">
	...
	<!-- 主机 -->
	 ...
	 <div class="info_machine_left fl">
		<div align="center"><br>
			<span style="font-size: 15px;">班组：</span><span id="team" style="font-size: 15px;">-</span>
			<span style="font-size: 15px;">班次：</span><span id="shift" style="font-size: 15px;">-</span>
		</div>	
	</div>
	 <div class="info_machine_left fl">
		<div align="center"><br>
			<span style="font-size: 15px;">设备型号:</span>
			<span style="font-size: 15px;" id="equtype"></span>
		</div>	
	</div>
	 <div class="info_machine_left fl">
		<div align="center"><br>
			<span style="font-size: 15px;">额定车速:</span>
			<span style="font-size: 15px;" id="equipmentEdcs"></span>
		</div>	
	</div>
</div>
<div class="info_area">
